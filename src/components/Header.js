...
const Header = () => {
  ...
  const navigation = [
    ...
    { name: 'วางแผนออกกำลังกาย', href: '/planner', icon: CalendarIcon },
    { name: 'คลังท่าออกกำลังกาย', href: '/exercises', icon: BookOpenIcon },
    { name: 'ติดตามความก้าวหน้า', href: '/progress', icon: ChartBarIcon },
    { name: 'คำนวณแคลอรี่', href: '/calculator', icon: CalculatorIcon },
  ];
